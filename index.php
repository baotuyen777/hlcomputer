            ...
            <nav id="nav" class="menu">
                <div class="container">
                    ...
                    <ul class="menu__list hidden-xs">
                        ...
                        <li class="menu__item"><a href="/linh-kien-laptop" class="menu__link">Linh Kiện - Thiết bị</a>
                            <ul class="menu-sub">
                                <li class="menu-sub__item"><a href="/laptop-dell" class="menu-sub__link">Linh Kiện máy tính</a>
                                    <ul class="menu-sub">
