    ...
    <div class="container">
        <div class="bg-slider">
            <div id="slider" class="theme-default">
                <a href="#">
                    <img src="<?php echo SITE_ROOT ?>img/home-slider-1.jpg?1524124143478" alt="slide 1" />
                </a>
                <a href="#">
                    <img src="<?php echo SITE_ROOT ?>img/banner.jpg" alt="slide 2" />
                </a>

                <!--                            <a href="#">
                                                <img src="<?php echo SITE_ROOT ?>img/home-slider-2.jpg?1524124143478" alt="slide 2" />
                                            </a>
                
                
                                            <a href="">
                                                <img src="<?php echo SITE_ROOT ?>img/home-slider-3.jpg?1524124143478" alt="slide 3" />
                                            </a>-->
        ...
        <div class="row">
                        ...
                        <ul class="catalog__list">
                            <li class="catalog__item" >
                                <a href="/laptop-game-do-hoa" title="Laptop Game & Đồ Họa">
                                    ...
                                    <span class="catalog__icon">
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-3.png?1524124143478" alt="Laptop Game & Đồ Họa" class="icon-old" />
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-hover3.png?1524124143478" alt="Laptop Game & Đồ Họa" class="icon-even" />
                                    </span>
                            ...
                            <li class="catalog__item" >
                                <a href="/danh-muc-laptop" title="Danh mục Laptop">
                                    ...
                                    <span class="catalog__icon">
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-3.png?1524124143478" alt="Danh mục Laptop" class="icon-old" />
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-hover3.png?1524124143478" alt="Danh mục Laptop" class="icon-even" />
                                    </span>
                            ...
                            <li class="catalog__item" >
                                <a href="/macbook" title="Macbook">
                                    ...
                                    <span class="catalog__icon">
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-3.png?1524124143478" alt="Macbook" class="icon-old" />
                                        <img src="<?php echo SITE_ROOT ?>img/icon-cate-hover3.png?1524124143478" alt="Macbook" class="icon-even" />
                                    </span>
                                ...
                                <div class="product-item__content">
                                    ...
                                    <div class="product-item__actions">
                                        ...
                                        <form action="/cart/add" method="post" class="variants" id="product-actions-18686961" enctype="multipart/form-data">
                                            ...
                                            <button class="button btn-cart add_to_cart" title="Chi tiết" aria-label="Chi tiết"><span>Chi tiết</span></button>
            ...
            <div class="col-md-3 hidden-md hidden-sm hidden-xs">
                <div class="three-module__banner_right">
                    <a href="#">
                        <img src="<?php echo SITE_ROOT ?>img/home-banner-right.jpg?1524124143478" alt="banner" />
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="three-banner__list">
                    <div class="row">
                        <div class="three-banner__item col-md-4 col-sm-4 col-xs-12">
                            <a href="#">
                                <img src="<?php echo SITE_ROOT ?>img/rhs-banner-1.jpg?1524124143478" alt="latop dell latitude e6420" />
                            </a>
                        </div>
                        <div class="three-banner__item col-md-4 col-sm-4 col-xs-12 hidden-xs">
                            <a href="#">
                                <img src="<?php echo SITE_ROOT ?>img/rhs-banner-2.jpg?1524124143478" alt="latop dell latitude e6430" />
                            </a>
                        </div>
                        <div class="three-banner__item col-md-4 col-sm-4 col-xs-12 hidden-xs">
                            <a href="/">
                                <img src="<?php echo SITE_ROOT ?>img/rhs-banner-3.jpg?1524124143478" alt="Samsung Galaxy Note 6" />
                            </a>
                        </div>
                    </div>
                </div>
...
<section class="banner-large hidden-xs">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <a href="#">
                    <img src="<?php echo SITE_ROOT ?>img/home-banner-center.jpg?1524124143478" alt="banner" />
                </a>
            </div>
        </div>
    </div>
...
<footer class="footer" id="footer">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 footer__col">
                ...
                <ul class="footer__col--list">
                    ...
                    <li>Ngân hàng VCB (Thăng Long) </li>
                    <li>Số tk: 049 100 0037 189</li>
                    <li>CTK: LAI VAN HIEP</li>
                </ul>
                <div style="border-bottom:1px solid #ccc"></div>
                <ul class="footer__col--list">
                    <li>Ngân hàng Shb (Cầu Diễn)</li>
                    <li>Số tk: 100 490 2129</li>
                    <li>CTK: LAI VAN HIEP</li>
                </ul>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 footer__col">
                ...
                <div class="item-info">
                    ...
                    <address>Địa chỉ: Ngõ 1, Văn Tiến , Đình Quán, Bắc Từ , Hà Nội</address>
                </div>
                <div class="item-info">
                    <div class="item-info__icon">
                        <i class="fa fa-mobile" aria-hidden="true"></i>
                    </div>
                    <p>Hotline 1: <a href="tel:0985358618">0985358618</a></p>
                    <p class="">Hotline 2: <a href="tel:0985358618">0985358618</a></p>
                </div>
                ...
                <div class="item-info">
                    ...
                    <p style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;"><a href="mailto:info@hlcomputer.vn">info@hlcomputer.vn</a></p>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 footer__col">
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="fb-page" data-href="https://www.facebook.com/maytinhhieplai/" data-tabs="timeline" data-height="250" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="https://www.facebook.com/maytinhhieplai/" class="fb-xfbml-parse-ignore">
                                <a href="https://www.facebook.com/maytinhhieplai/">Facebook</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
    ...
    <div class="copyright">
        <div class="container text-center">
            ...
            <div class="social">
                <a class="fa fa-facebook" href="Link_facebook"></a>
                <a class="fa fa-google-plus" href="Link_google"></a>
                <a class="fa fa-twitter" href="Link_twitter"></a>
                <a class="fa fa-youtube" href="Link_youtube"></a>
            </div>
        </div>
    </div>
    <span class="hotline-fix">Hotline: <span><a href="tel: 0985358618">0985358618</a> </span></span>
</footer>
